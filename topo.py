...
class SwatTopo(Topo):
    ...
    def build(self):
        ...
        self.addLink(s3, rtu1)
        self.addLink(s4, rtu1)
        ...
        self.addLink(s3, rtu2)
        self.addLink(s4, rtu2)
        ...
        self.addLink(rtu3,s3)
        self.addLink(rtu3,s4)
        ...
        self.addLink(s4, scada)
        self.addLink(s3, scada)
        self.addLink(s5, scada)
        self.addLink(s6, scada)
        
        historian = self.addHost(
        	'historian',
        	ip=IP['historian'] + NETMASK,
        	mac=MAC['historian'])
        self.addLink(historian,s5)
        self.addLink(historian,s6)
        self.addLink(s1,s2)
        self.addLink(s3,s2)
        self.addLink(s3,s4)
        self.addLink(s4,s5)
